...
{
	//printf("\n naryTree display beg of delete:  ");	
	...
	//***********************************PATH NOT VALID IF ROOT IS NULL********************************//
		...
		//**********************************CANNOT_FIND_SPECIFIED_DIR1**********************************//
			
			
				
			//printf("not error code: CANNOT_FIND_SPECIFIED_DIR1");
			//printf("Invalid path");		
		}
	
	
	//*******************************DO THIS IF THE PATH IS VALID*************************//
		else 		
		{
	...
	//*************************Delete first child******************************//
		...
		//**********************************CANNOT_FIND_SPECIFIED_DIR3**********************************//
							...
							//printf("%s",temp1->fileDesc->fileName);
							exitStatus=TRUE;
						}
	...
	//*******************************Delete right sibling************************************//
		...
		//**********************************DIRECTORY_IS_NOT_EMPTY2**********************************//
					
					
										
										//printf("not error code: DIRECTORY_IS_NOT_EMPTY2");
										exitStatus=TRUE;					
									}
								}
